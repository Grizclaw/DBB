...
<div class="row">
	<div class="col-md-7">
		<div class="alert alert-info">
			<p>
				<i>Bagi Pembayaran Non Tunai</i><br>
				Silahkan Melakukan Pembayaran Rp. <?php echo number_format($detail['total_pembelian']); ?> Ke <br>
				<strong>BANK BRI 0836-0101-7480-537   AN. ABYAN PUTRA SHALIH</strong>
				<br>
				<strong>Bagi Pembayaran Tunai, Silakan Melalui Kasir untuk melakukan pembayaran</strong>
			</p>
		</div>
