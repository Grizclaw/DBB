...
<section class="konten">
	<div class="container"><br>
		...
		<form method="POST">
			...
			<h2>Pembayaran</h2>
				<input class="form-check-input" type="radio" name="tipe_pembayaran" value="tunai"> Tunai <br>
				<input class="form-check-input" type="radio" name="tipe_pembayaran" value="non tunai"> Non Tunai
			<br>
		...
		if (isset($_POST["checkout"])) 
		{
			...
			$koneksi->query("INSERT INTO pembelian(
				id_pelanggan, tanggal_pembelian, total_pembelian, tipe_pembayaran)
				VALUES('$id_pelanggan', '$tanggal_pembelian', '$total_pembelian', '$tipe_pembayaran')"
					);
